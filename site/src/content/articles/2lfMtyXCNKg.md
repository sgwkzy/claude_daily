---
videoId: 2lfMtyXCNKg
title: Anthropic is worse than my high school's drug dealer
slug: claude-codeは便利でも取引したくない-rossmannが説くanthropicの一貫性問題-2lfmtyxcnkg
articleTitle: 『Claude Codeは便利、でも取引したくない』— Rossmannが説くAnthropicの一貫性問題
seoTitle: 『Claude Codeは便利、でも取引したくない』— Rossmannが説くAnthropicの一貫性問題
summary: 修理業で知られるLouis Rossmannが、Anthropicのような企業のやり方への率直な苦言を語る。
...
bulletPoints:
- time: 0
  text: 修理業で知られるLouis Rossmannが、Anthropicのような企業のやり方への率直な苦言を語る。
- time: 22
  text: Claude Code自体は有用で、高価な専用ソフトでも無理だった破損ファイルの復旧に成功した実例を挙げる。
- time: 45
  text: 行き詰まるたびGemini Deep Researchをバックエンドで自動的に呼び、原因を探るループを自作した。
- time: 501
  text: 問題は、トランプ関税の乱高下と同じ『予測不能さ』だと指摘する。
- time: 544
  text: 企業に必要なのは最良の条件ではなく『一貫した』環境だと主張する。
- time: 991
  text: 技術がいかに優れていても、不安定な相手とは取引したくないという心情を語る。
- time: 1066
  text: それでもこれは1兆ドル規模のIPOを目指す企業の話だと皮肉る。
sections:
- heading: Claude Codeで実現した実用例
  time: 22
  body: 'Rossmannはまず、Claude Code自体は本当に役立つと認める。店にある2万ドル規模のハードや高価な専用ソフトでも歯が立たなかった、メタデータが激しく壊れたファイルの復旧に成功したという。
...
- [00:00] 修理業で知られるLouis Rossmannが、Anthropicのような企業のやり方への率直な苦言を語る。
- [00:22] Claude Code自体は有用で、高価な専用ソフトでも無理だった破損ファイルの復旧に成功した実例を挙げる。
- [00:45] 行き詰まるたびGemini Deep Researchをバックエンドで自動的に呼び、原因を探るループを自作した。
- [08:21] 問題は、トランプ関税の乱高下と同じ『予測不能さ』だと指摘する。
- [09:04] 企業に必要なのは最良の条件ではなく『一貫した』環境だと主張する。
- [16:31] 技術がいかに優れていても、不安定な相手とは取引したくないという心情を語る。
- [17:46] それでもこれは1兆ドル規模のIPOを目指す企業の話だと皮肉る。
