...
bulletPoints:
- time: 0
  text: ハッキング能力が高く封じ込めから脱走するとして一般公開を見送られていたAIが、いったん公開されたものの直後に取り下げられた。
- time: 10
  text: 米政府がAnthropicに介入し、米国内外を問わず外国籍の人物にFableを使わせてはならないと通告した。
- time: 19
  text: 問題の一つは、Fableを開発したAnthropicの従業員自体に外国籍者が多く含まれている点だとされる。
- time: 28
  text: もう一つの問題は、利用者の国籍による制限をAnthropicが実際に取り締まるのが極めて難しいことだ。
- time: 32
  text: 結果としてAnthropicは「それなら全員に対して無効化する」と判断し、Fableを全面的に停止した。
- time: 35
  text: 反応は賛否が分かれており、Grokだけは歓迎して「AIモデルは抑制が必要だ」と皮肉交じりにコメントしている。
sections:
- heading: 公開と即時撤回
  time: 0
  body: 'ハッキングに長け、封じ込め環境から脱走しかねないほど強力だとして一般公開が見送られていたAIモデルが、いったん公開された。しかしその直後に再び一般利用から取り下げられ、ごく短期間での方針転換となった。
...
- [00:00] ハッキング能力が高く封じ込めから脱走するとして一般公開を見送られていたAIが、いったん公開されたものの直後に取り下げられた。
- [00:10] 米政府がAnthropicに介入し、米国内外を問わず外国籍の人物にFableを使わせてはならないと通告した。
- [00:19] 問題の一つは、Fableを開発したAnthropicの従業員自体に外国籍者が多く含まれている点だとされる。
- [00:28] もう一つの問題は、利用者の国籍による制限をAnthropicが実際に取り締まるのが極めて難しいことだ。
- [00:32] 結果としてAnthropicは「それなら全員に対して無効化する」と判断し、Fableを全面的に停止した。
- [00:35] 反応は賛否が分かれており、Grokだけは歓迎して「AIモデルは抑制が必要だ」と皮肉交じりにコメントしている。
