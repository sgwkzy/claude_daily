...
fetchedAt: '2026-06-12T02:51:00.303882Z'
originalThumbnail: https://example.com/thumb-claude-code.webp
headerImage: /images/dryrun-claude-code/header.webp
viewCount: 184000
durationSec: 612
sourceLanguage: ja
matchedKeywords:
...
- heading: Claude Codeをなぜ使うのか
  ...
  image: /images/dryrun-claude-code/scene-1.webp
- heading: 実装フロー：プロンプトの前にコンテキスト
  ...
  image: /images/dryrun-claude-code/scene-2.webp
- heading: MCPで社内ツールを接続する
  ...
  image: /images/dryrun-claude-code/scene-3.webp
- heading: 運用：承認モードを使い分ける
  ...
  image: /images/dryrun-claude-code/scene-4.webp
---
...
- 時刻: 00:00
- 画像: /images/dryrun-claude-code/scene-1.webp
...
- 時刻: 01:12
- 画像: /images/dryrun-claude-code/scene-2.webp
...
- 時刻: 06:00
- 画像: /images/dryrun-claude-code/scene-3.webp
...
- 時刻: 08:30
- 画像: /images/dryrun-claude-code/scene-4.webp
